  ...
  return (
    <div>
      ...
      <Modal className='cardModalContainer' open={open} onClose={handleClose} aria-labelledby={card.name}>
        <div>
          <img src={card.card_faces?.[0]?.image_uris ? card.card_faces[0].image_uris.large : card.image_uris.large} onClick={handleClose} />
          <img src={card.card_faces?.[1]?.image_uris ? card.card_faces[1].image_uris.large : null} onClick={handleClose} />
        </div>
      </Modal>
    </div>
  )
